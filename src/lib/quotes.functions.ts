...
اللغة: **عربية فصحى مبسطة فقط**. ممنوع منعاً باتاً استخدام الدارجة المغربية أو أي لهجة عامية (لا "دابا"، لا "زير"، لا "البارح"، لا "تبارك الله"، لا "شويه"، لا "كمل"...). استعمل: الآن، تابع، أمس، ما شاء الله، قليلاً، واصل.
